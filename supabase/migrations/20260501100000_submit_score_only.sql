...
-- 2026-05-01: Submission requires only the final score. Screenshots, team
-- stats, quarter scores, and goal kickers are now all optional. The frontend
-- has been simplified to a score-only flow; this migration removes the
-- backend "At least one screenshot is required" guard so the RPC accepts
-- payloads without any screenshots/team stats/quarters/kickers.
