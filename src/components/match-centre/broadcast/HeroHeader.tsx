          ...
          <div className="mcHeroShell__stage">
            ...
            >
              ...
              <div className="mcHeroShell__logoWrap">
                <SmartImg src={homeLogo} alt={home?.fullName || 'Home'} className="mcHeroShell__logo" fallbackText={homeAbbr} />
              </div>
            ...
            >
              ...
              <div className="mcHeroShell__logoWrap">
                <SmartImg src={awayLogo} alt={away?.fullName || 'Away'} className="mcHeroShell__logo" fallbackText={awayAbbr} />
              </div>
              <div className="mcHeroShell__teamText">
